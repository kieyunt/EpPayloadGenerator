...
public class FlDeliveryOrderTest extends TestCase {
	...
	public void testRetrieve() {
		...
		flDeliveryOrders.forEach(a->System.out.println(a.getDeliveryOrderId()+"|"+a.getDeliveryOrderNo()+"|"+a.getCreatedDate()+"|"+a.getFlRequest().getDocNo()+"|"+a.getFlFulfilmentOrder().getDocNo()+"|"+a.getFlRequest().getAgOffice().getOfficeCode()));
